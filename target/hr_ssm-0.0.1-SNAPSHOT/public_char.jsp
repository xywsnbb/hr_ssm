	...
	<form method="post" action="configpublicchar.do">
		<table width="100%">
			...
			<tr>
				<td align="right"><input type="button" value="添加"
					class="BUTTON_STYLE1" onclick="window.location.href='publicCharController/add.do'"></td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<c:forEach items="${list }" var="Config_public_char" varStatus="i">
				<tr>
					<td class="TD_STYLE2">${Config_public_char.attribute_kind }</td>
					<td class="TD_STYLE2">${Config_public_char.attribute_name }</td>
					<td class="TD_STYLE2" align="center"><a
						href="publicCharController/delete.do?pbc_id=${Config_public_char.pbc_id }">删除</a></td>
				</tr>
			</c:forEach>
		</table>
		<p>

...
<body>
	<form name="configfilefirstkindForm" method="post"
		action="configfilefirstkind/update.do">
		<input type="hidden" value="${cffk.ffk_id }" name="ffk_id">
		<table width="100%">
			<tr>

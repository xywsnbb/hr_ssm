...
<body>
	<form method="post" action="configfilesecondkind/remove.do?fsk_id=${cfsk.fsk_id}">
		<table width="100%">
			<tr>
			...
			<tr>
				<td width="49%">您确认删除${cfsk.first_kind_id }/ ${cfsk.second_kind_id }/ ${cfsk.second_kind_id } 这条记录吗?</td>

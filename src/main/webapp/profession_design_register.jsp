...
<body>
	<form name="configMajorKindControllerForm" method="post"
		action="professionDesignController/save.do">
		<table width="100%">
			<tr>
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				<td width="19%" class="TD_STYLE1">职位分类</td>
				<td width="81%" class="TD_STYLE2">职称</td>
				<input type="hidden" value="职称" name="attribute_kind">
			</tr>
			<tr>

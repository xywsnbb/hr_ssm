...
<body>
	<form name="configfilefirstkindForm" method="post"
		action="configQuestionSecondKind/update.do">
		<table width="100%">
			<tr>
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				...
				<input type="hidden"  name="first_kind_id" value="<%=request.getParameter("first_kind_id") %>" id="first_kind_id"/>
				<td width="81%" class="TD_STYLE2"><!-- <input type="text"
					name="first_kind_id" class="INPUT_STYLE1"> -->
					<select id="select_1">
						<option><%=request.getParameter("first_kind_id") %></option>
			...
			<tr>
				...
				<input type="hidden" name="first_kind_name" value="<%=request.getParameter("first_kind_name") %>" id="first_kind_name"/>
			...
			<tr>
				...
				<input type="hidden" name="qsk_id" value="<%=request.getParameter("qsk_id") %>">
				<input type="hidden" name="second_kind_id" value="<%=request.getParameter("second_kind_id") %>">
				<td width="81%" class="TD_STYLE2"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">II级种类试题名称</td>
				<td class="TD_STYLE2">
				<input type="text" name="second_kind_name" value="<%=request.getParameter("second_kind_name") %>"></td>
			</tr>
		</table>
	</form>
</body>

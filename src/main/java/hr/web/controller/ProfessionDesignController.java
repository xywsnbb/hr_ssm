...
@Controller
@RequestMapping("/professionDesignController")
public class ProfessionDesignController {
	@Autowired
	private Config_public_charService service = null;
	
	@RequestMapping("/query.do")
	public String queryProfessionDesign(Model model) {
		List<Config_public_char> list = service.queryConfig_public_charKind();
	...
	public String deleteProfessionDesign(@RequestParam("pbc_id") String pbc_id,Model model) {
		...
		return "forward:/profession_design_delete.jsp";
	}
	...
	public String removeProfessionDesign(@RequestParam("pbc_id") String pbc_id) {
		...
		if (falg) {
			return "redirect:/professionDesignController/query.do";
		}
		return null;
	}
